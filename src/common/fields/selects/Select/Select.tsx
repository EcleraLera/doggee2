  ...
  const SelectIcon = React.useCallback(
    () => (
      <div
        ...
        style={
          {
            // transform: !state.showOptions ? 'rotate(90deg)' : 'rotate(-90deg)',
          }
        }
      >
  ...
  return (
    ...
    >
      <div
        ...
        className={classnames(inputStyles.container, {
        ...
        <div className={`${inputStyles.input}`}>
          ...
          <label
            ...
            className={classnames(selectStyles.input_label, {
              [selectStyles.translated_input_label]:
                state.showOptions || showOption,
            })}
          >
            {props.label}
          </label>
